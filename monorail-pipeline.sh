...
# activate conda environment for reproducibility
conda activate DS-transfer
...
#     # touch $FILENAME
#     # echo -e 'sample_id\tstudy_id' >> $FILENAME
...
/scratch/alpine/lgillenwater@xsede.org/monorail-external/singularity/run_recount_unify.sh \
			    /scratch/alpine/lgillenwater@xsede.org/monorail-external/htp/unifier/recount-unify_1.1.0.sif \
			    hg38 \
			    ...
			    /scratch/alpine/lgillenwater@xsede.org/monorail-external/htp/output \
